...
int main(int argc, char** argv)
{
    ...
    ground.addComponent<DiffuseMaterial>(Vec3<float>(0.9f, 0.9f, 0.9f), 0.77f);
    ...
    left.addComponent<DiffuseMaterial>(Vec3<float>(0.9f, 0.9f, 0.9f), 0.99f);
