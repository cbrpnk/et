...
int main(int argc, char** argv)
{
    ...
    ground.addComponent<Transform>(0.0f, -1.0f, 0.0f);
    ground.addComponent<SdfPlane>(0.0f, 1.0f, 0.0f);
    ground.addComponent<DiffuseMaterial>(RgbColor<float>(0.8f, 0.8f, 0.8f), 0.77f);
    
    Obj& sphere = scene.createObj();
    sphere.addComponent<Transform>(0.0f, 0.0f, -10.0f);
    ...
    sphere2.addComponent<Transform>(-2.0f, 0.0f, -3.0f);
    ...
    sphere3.addComponent<Transform>(7.0f, 0.0f, -20.0f);
    ...
    sphere4.addComponent<Transform>(6.0f, 0.0f, -40.0f);
