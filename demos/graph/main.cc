...
int main(int argc, char** argv)
{
    ...
    camera.addComponent<Camera>(Camera::AspectRatio(16.0f, 9.0f), 60.0f, 0.7f, 10.0f);
    ...
    */
    ...
    sphere2.addComponent<MetalicMaterial>(RgbColor<float>(0.5f, 0.5f, 0.5f), 0.9f, 0.1f);
    */
    
    Obj& sphere3 = scene.createObj();
    sphere3.addComponent<Transform>(Vec3<float>(-4.0f, 0.0f, -29.0f));
    ...
    cubeWall.addComponent<Transform>(Vec3<float>(-10.0f, 0.0f, -21.0f));
    ...
    sphere4.addComponent<Transform>(Vec3<float>(1.5f, -0.7f, -4.0f));
